...
Для чтения информации с порта используется библиотека Boost.Asio. Для виртуальной машины нужно настроить COM порты. На данный момент чтение с порта не работает.
